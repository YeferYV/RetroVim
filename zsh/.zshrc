...
export VIMINIT="luafile $CONDA_PREFIX/opt/retrovim/nvim/init.lua" # luafile seems faster then `source` and `dofile`
...
export CONDA_PREFIX=${CONDA_PREFIX:-$HOME/.pixi/envs/retrovim}
export EDITOR="nvim"
...
export LESSKEYIN="$CONDA_PREFIX/opt/retrovim/yazi/lesskey" # bat keymaps
...
export STARSHIP_CONFIG="$CONDA_PREFIX/opt/retrovim/zsh/starship.toml"
export YAZI_CONFIG_HOME="$CONDA_PREFIX/opt/retrovim/yazi"
export ZSH_PATINA_CONFIG_PATH="$CONDA_PREFIX/opt/retrovim/zsh/zsh-patina.toml"
